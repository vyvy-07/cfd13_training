...
const Header = () => {
  const { profiles, onLogOut, openAuthModal } = useAuthen();
            ...
            <div className="userlogged__dropdown dropdown">
              <div className="userlogged__dropdown-info">
                <div className="user__img">
                  <img src="img/profiles.png" alt="Avatar teacher" />
                </div>
                <Link to={PATHS.PROFILE.INDEX} className="user__info">
                  <p className="title --t4">
                    <strong>{profiles?.firstName || ""}</strong>
                  </p>
              ...
              <div className="userlogged__dropdown-list">
                ...
                >
                  {profiles?.id ? "Đăng xuất" : "Đăng nhập"}
                  <i>
